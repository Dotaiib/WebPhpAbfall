...
{    
     ...
     $sql = "INSERT INTO Reklamationen (R_Produkt,R_Charge,R_Grund,R_Gebindeinhalt,R_AnzahlGebinde,R_Menge,R_Abfallart)
...
<form method="post">
    ...
    <h2 class="display-2">Reklamationen</h2> <br/>
    ...
    <?php
include 'Connection.php';
$sql = "select R_Produkt,R_Charge,R_Grund,R_Gebindeinhalt,R_AnzahlGebinde,R_Menge,R_Abfallart from Reklamationen order by R_Save_Time desc";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr>";
                echo "<td>" . $row['R_Produkt'] . "</td>";
                echo "<td>" . $row['R_Charge'] . "</td>";
                echo "<td>" . $row['R_Grund'] . "</td>";
                echo "<td>" . $row['R_Gebindeinhalt'] . "</td>";
                echo "<td>" . $row['R_AnzahlGebinde'] . "</td>";
                echo "<td>" . $row['R_Menge'] . "</td>";
                echo "<td>" . $row['R_Abfallart'] . "</td>";
        echo "</tr>";
    }
    echo "</table>";
    echo"</div>";
