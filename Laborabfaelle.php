...
{    
     ...
     $sql = "INSERT INTO Laborabfaelle (L_Produkt,L_Charge,L_Grund,L_Gebindeinhalt,L_AnzahlGebinde,L_Menge,L_Abfallart)
...
<form method="post">
    ...
    <h2 class="display-2">Laborabfälle</h2> <br/>
    ...
    <?php
include 'Connection.php';
$sql = "select L_Produkt,L_Charge,L_Grund,L_Gebindeinhalt,L_AnzahlGebinde,L_Menge,L_Abfallart from Laborabfaelle order by L_Save_Time desc";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr>";
                echo "<td>" . $row['L_Produkt'] . "</td>";
                echo "<td>" . $row['L_Charge'] . "</td>";
                echo "<td>" . $row['L_Grund'] . "</td>";
                echo "<td>" . $row['L_Gebindeinhalt'] . "</td>";
                echo "<td>" . $row['L_AnzahlGebinde'] . "</td>";
                echo "<td>" . $row['L_Menge'] . "</td>";
                echo "<td>" . $row['L_Abfallart'] . "</td>";
        echo "</tr>";
    }
    echo "</table>";
    echo"</div>";
