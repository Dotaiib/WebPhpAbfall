...
{    
     ...
     $sql = "INSERT INTO Sonstiges (S_Produkt,S_Charge,S_Grund,S_Gebindeinhalt,S_AnzahlGebinde,S_Menge,S_Abfallart)
...
<form method="post">
    ...
    <h2 class="display-2">Sonstiges</h2> <br/>
    ...
    <?php
include 'Connection.php';
$sql = "select S_Produkt,S_Charge,S_Grund,S_Gebindeinhalt,S_AnzahlGebinde,S_Menge,S_Abfallart from Sonstiges order by S_Save_Time desc";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr>";
                echo "<td>" . $row['S_Produkt'] . "</td>";
                echo "<td>" . $row['S_Charge'] . "</td>";
                echo "<td>" . $row['S_Grund'] . "</td>";
                echo "<td>" . $row['S_Gebindeinhalt'] . "</td>";
                echo "<td>" . $row['S_AnzahlGebinde'] . "</td>";
                echo "<td>" . $row['S_Menge'] . "</td>";
                echo "<td>" . $row['S_Abfallart'] . "</td>";
        echo "</tr>";
    }
    echo "</table>";
    echo"</div>";
